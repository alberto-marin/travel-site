...
var Modal = function () {
  ...
  _createClass(Modal, [{
    ...
    value: function openModal() {
      ...
      return false; // for not scrolling up when clicking
    }
  }, {
    key: 'closeModal',
...
var RevealOnScroll = function () {
  function RevealOnScroll(cssClass, offset) {
...
var StickyHeader = function () {
  ...
  _createClass(StickyHeader, [{
    ...
    value: function createHeaderWaypoint() {
      var that = this;
      new Waypoint({
        element: this.headerTriggerElement[0], // with [0] point to the native DOM element
